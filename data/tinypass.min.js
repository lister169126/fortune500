...
!function () {
    ...
    var yo, wo, _o = function () {
        ...
        var S, E, T = function (e) {
            ...
            return void 0 === e && (e = ""), '<div class="tp-please-wait tp-active tp-overlap '.concat(e, '"><div class="tp-icon tp-centered"><div class="pn-spinner"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div></div>')
        }, ne = function () {
    ...
    var ma = function () {
        var e, n, t = 0, r = document, o = !1, i = "active", a = 6e4, s = function () {
            ...
            for (e = function () {
                return n.innerHTML = "\x3c!--[if gt IE " + ++o + "]><i></i><![endif]--\x3e", t[0]
            }; e();) ;
            return o > 4 ? o : void 0
        }();
